  ...
  return (
    <>
      <Head>
        ...
        <meta property="og:title" content="Minicurso de Férias - Matemática | RD Monitoria"/>
        ...
        <meta property="twitter:title" content="Minicurso de Férias - Matemática | RD Monitoria"/>
